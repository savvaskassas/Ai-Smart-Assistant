...
1. **FastAPI Documentation**
   ...
   - Used for: REST API framework, async operations, automatic API documentation

2. **React Documentation**
   - URL: https://react.dev/
   - Used for: Frontend framework, component architecture, hooks

3. **Material-UI (MUI)**
   - URL: https://mui.com/
   - Used for: UI components, theming system, responsive design

4. **Vite Documentation**
   - URL: https://vitejs.dev/
   - Used for: Build tool, development server, fast HMR
